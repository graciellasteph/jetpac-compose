...
class LazyColoumnActivity : ComponentActivity() {
        ...
        setContent {
            JetPacComposeTheme {
                ...
                Surface(
                    ...
                    val students = listOf("John","James","Andrew",
                        "Matthew","Peter","Precious","Perpetual",
                        "Lucy","Magdalene","Felix","Shalom","Benjamin")
                    LazyHome(students)
                }
            }
        }
...
@Composable
fun LazyHomePreview(){
    LazyHome(students = listOf("jane","Judith","John","James","Andrew",
        "Matthew","Peter","Precious","Perpetual",
        "Lucy","Magdalene","Felix","Shalom","Benjamin"))
}